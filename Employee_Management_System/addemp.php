    ...
    <header>
        <nav>
            ...
            <ul id="navli">
                ...
                <li><a class="homered" href="addemp.php">Add Faculty</a></li>
                ...
                <div class="card-body">
                    ...
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="date" placeholder=" Date Of Joining" name="birthday" required="required">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="Serial Number" name="nid" required="required">
                        </div>

                        
                         <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Position" name="address" required="required">
                        </div>
                       ...
                       <!-- <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="Faculty Status" name="salary">
                        </div>-->
